        ...
        switch (node.type) {
            case 'bucket':
                ...
                $.ajax({
                    ...
                    error: function (err) {
                        alert('Upload file not successfull - Internal Server Error')
                        console.log(err);
                    }
                });
                break;
            ...
            getForgeToken(function (access_token) {
                jQuery.ajax({
                    ...
                    success: function (res) {
                        ...
                        //else
                        //var bar1 = new ldBar("#forgeViewer");
                        //var bar2 = document.getElementById('forgeViewer').ldBar;
...
function translateObject(node) {
    ...
    jQuery.post({
        ...
        error: function (err) {
            alert('Translate not succesful - Internal Server Error')
            console.log(err);
        }
    });
    $('#appBuckets').jstree(true).refresh();
...
function commonOpenLoadingText(id) {
    let $this = $(id);
    let loadingText = '<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> Đang xử lý...';
...
function deleteBucket() {
    ...
    jQuery.post({
        ...
        error: function (err) {
            alert('Bucket not deleted - Internal Server Error')
            console.log(err);
            $('body').html();
        }
    });
